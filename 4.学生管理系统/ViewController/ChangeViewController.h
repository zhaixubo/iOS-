...
@interface ChangeViewController : ViewController<UITableViewDelegate, UITableViewDataSource, ChangeDelegate, UITextFieldDelegate>
...
@property (assign, nonatomic) id <ChangeDelegate> delegate;
